...
def CHINA_TOUR():
	...
	with open("C:/Users/彭靖茜/Desktop/彭靖茜-finall/中国旅游业.html", encoding="utf8", mode="r") as f:
		plot_all = "".join(f.readlines()) #本地文件，查看需要更改路径
	return render_template('G.html',
...
def CHINA_GNI():
 ...
 with open("C:/Users/彭靖茜/Desktop/彭靖茜-finall/国民总收入.html", encoding="utf8", mode="r") as f:
  plot_all = "".join(f.readlines()) #本地文件，查看需要更改路径
 return render_template('G.html',
                        the_plot_all = plot_all)
